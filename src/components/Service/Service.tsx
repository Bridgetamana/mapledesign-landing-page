...
const services: ServiceItem[] = [
    ...
    {
        number: 2,
        tags: ['UI/UX', 'User Research & Testing', 'Product Strategy', 'Wireframes & Flow', 'Design Systems'],
    ...
    {
        number: 4,
        tags: ['UI/UX', 'Content Strategy', 'Visual Design', 'Content Management', 'User Testing'],
        text: 'Website design',
    ...
    useEffect(() => {
        const handleResize = () => {
            if (window.innerWidth > 900) {
                ...
                setIsServiceNumberVisible(false);
            }
        };
                ...
                <div className="number-container">
                    <div className="number-details">
                        ...
                        <div className="number-description">
                            More than USD 10 million raised by our clients from our collaboration
                        </div>
                    </div>
                    <div className="number-details">
                        <h2 className="number-title">40+</h2>
                        <div className="number-description">
                            We have helped 40+ businesses in building from scratch
                        </div>
                    </div>
                    <div className="number-details">
